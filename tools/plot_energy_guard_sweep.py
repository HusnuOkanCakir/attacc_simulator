...
def main() -> int:
    ap = argparse.ArgumentParser(description="Plot energy-latency-guard sweep results.")
    ap.add_argument("--summary-dir", type=Path,
                    default=Path("cluster_outputs/azure_energy_guard_sweep_noguard"))
    ap.add_argument("--out-dir", type=Path,
                    default=Path("cluster_outputs/azure_energy_guard_sweep_noguard_plots"))
    ap.add_argument("--prefix", default="azure_energy_guard_sweep_noguard")
    args = ap.parse_args()
