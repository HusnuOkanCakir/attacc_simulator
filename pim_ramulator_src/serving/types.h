...
struct FrontendConfig {
  ...
  std::string hybrid_command_source = "template_replay";
  ...
  std::string generator_backend = "lpddr5_bank";
  int generator_dhead = 128;
  int generator_heads_per_hbm = 1;
  int generator_dtype_bytes = 2;
  int generator_num_layers = 1;
  int generator_channel_count = 16;
  Addr_t translation_max_addr = 0;
  uint64_t translation_page_size_bytes = 4096;
  ...
  std::string kv_placement_csv;
  std::string allocator_pressure_csv;
...
struct RuntimeRequest {
  ...
  uint64_t pim_kv_bytes = 0;
  uint64_t pim_transient_peak_bytes = 0;
  std::string allocator_fallback_reason;
  double allocator_wait_ms = 0.0;
  std::optional<Clk_t> allocator_first_block_clk;
...
struct PimJob {
  ...
  std::shared_ptr<HybridCommandStream> command_stream;
  size_t next_cmd_idx = 0;
  bool has_pending_generated_cmd = false;
  int pending_generated_type_id = Request::Type::Read;
  Addr_t pending_generated_addr = 0;
  bool pending_generated_expects_callback = false;
...
struct RuntimeStats {
  ...
  int allocator_hold_count = 0;
  int allocator_gpu_fallback_count = 0;
  int allocator_drop_count = 0;
  ...
  uint64_t pim_memory_peak_bytes = 0;
  uint64_t kv_region_peak_bytes = 0;
  uint64_t score_region_peak_bytes = 0;
  uint64_t context_region_peak_bytes = 0;
  uint64_t scratch_region_peak_bytes = 0;
};
